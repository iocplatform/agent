...
func Build() {
	banner := figure.NewFigure("Agent", "", true)
	banner.Print()
...
func (Bin) Agent() error {
	return goBuild("github.com/iocplatform/agent/cli/agent", "agent")
}
...
func goBuild(packageName, out string) error {
	...
	varsSetByLinker := map[string]string{
		"github.com/iocplatform/agent/internal/version.Version":   tag(),
		"github.com/iocplatform/agent/internal/version.Revision":  hash(),
		"github.com/iocplatform/agent/internal/version.Branch":    branch(),
		"github.com/iocplatform/agent/internal/version.BuildUser": os.Getenv("USER"),
		"github.com/iocplatform/agent/internal/version.BuildDate": time.Now().Format(time.RFC3339),
		"github.com/iocplatform/agent/internal/version.GoVersion": runtime.Version(),
	}
